  ...
  return (
    <>
      ...
      >
        ...
        {/* New Project btn */}
        <button
          className="new-project-btn self-start flex items-center gap-2 text-white font-semibold text-sm px-5 py-2.5 rounded-xl"
          onClick={() => {
            setModalOpen(true);
            dispatch(setCreateProjectMode("create"));
          }}
        >
